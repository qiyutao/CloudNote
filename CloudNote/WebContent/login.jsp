...
<div class="LoginWindow">
	<div>
		<div class="login">
		<form name='f1' action="CheckServlet" method="post">
...
<div class="box">
	<div class="regiest">
	<form name='f2' action="RegistServlet" method="post">
		...
		<p><input type="password" id="finalPWD" name="password1" placeholder="确认密码"></p>
		<p><input type="text" id="email" name="email" placeholder="邮箱" ></p>
	</form>
		<div id="btn2">
			<ul>
